...
function Home2() {
  ...
  const [presentCount, setPresentCount] = useState(27);
  const [offDutyCount, setOffDutyCount] = useState(2);
  const [onLeaveCount, setOnLeaveCount] = useState(3);
  ...
  return (
    <div className="container">
      ...
      <h2 className="subtitle" style={{fontSize:'0.9cm'}}>My Report</h2>
